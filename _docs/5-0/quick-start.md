...
The ConDep DSL provides different kinds of operations. Above you saw two exmples, Remote and Local operations. There are other kinds of operations as well, have a look in [Runbooks](/docs/5-0/runbooks/) to see them.
